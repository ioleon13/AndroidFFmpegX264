 ...
 * file located at:
 *
 *   src/com/example/androidffmpegx264/H264Encoder.java
 */
jlong
Java_com_example_androidffmpegx264_H264Encoder_CompressBegin( JNIEnv* env, jobject thiz,
 ...
 */
jint
Java_com_example_androidffmpegx264_H264Encoder_CompressEnd( JNIEnv* env, jobject thiz, jlong handle)
{
 ...
 */
jint
Java_com_example_androidffmpegx264_H264Encoder_CompressBuffer( JNIEnv* env, jobject thiz, jlong handle,
